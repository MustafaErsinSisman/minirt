...
SRCS		= main.c ray.c objects/sphere.c objects/world.c objects/camera.c objects/light.c objects/ambient.c  objects/plane.c objects/cylinder.c objects/cylinder_utils.c
OBJS		= $(SRCS:.c=.o)
